# Пресс-релизы для max-hermes и max-hermes-plugin

## Вариант 1: Короткий (Telegram-каналы, 300-500 символов)
...
2️⃣ max-hermes-plugin — нативный плагин Hermes Gateway
   Прямая интеграция MAX без моста

Оба проекта: MIT, Python 3.11+

🔗 github.com/RuslanStrogov/max-hermes
🔗 github.com/RuslanStrogov/max-hermes-plugin
```
...
2️⃣ max-hermes-plugin — native Hermes Gateway plugin
   Direct MAX integration without bridge

Both: MIT, Python 3.11+
